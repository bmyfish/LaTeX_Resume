...
\sectionline
    ...
    C,\hspace{2mm}Java,\hspace{2mm}Python,\hspace{2mm}Assembly Language,\hspace{2mm}Verilog,\hspace{2mm}\LaTeX,\hspace{2mm}Visual Basic,\hspace{2mm}Matlab,\hspace{2mm}Operating System,\hspace{2mm}Socket Programming,\hspace{2mm}Tcp/Ip Protocol Suite,\hspace{2mm}SDN,\hspace{2mm}Wireshark,\hspace{2mm}OPNET,\hspace{2mm}Wireless Sensor Network,\hspace{2mm}Contiki,\hspace{2mm}Linux,\hspace{2mm}Unix,\hspace{2mm}Embedded Systems,\hspace{2mm}FPGA,\hspace{2mm}Mac OS,\hspace{2mm}Windows.
